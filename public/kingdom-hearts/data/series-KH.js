...
window.__khSeriesReg['KH'] = { num: 'KH', chronoOrder: 1075, recommendedOrder: 1795, title: 'Kingdom Hearts', note: [
  ...
  { chronoOrder: 189, recommendedOrder: 999, mediaType: 'Game',
    ...
    mediaDesc: [
      [
        { text: 'Pure arcade-style Match 3 puzzle gameplay, with little to no story. Meant to promote the release of ' },
        { emLinkText: '358/2 Days (2009)', emLinkUrl: '#entry-KH-kingdom-hearts-358-2-days-2009' },
        { text: '. Released as ' },
        { emText: 'Kingdom Hearts 358/2 Days Magical Puzzle Clash' },
  ...
  { chronoOrder: 190, recommendedOrder: 290, mediaType: 'Game',
    ...
    primary: { tags: ['Optional', 'Action RPG', 'Single-player', 'Co-op'],
      length: [{ value: '26½h', tip: 'Main Story' }, { value: '34h', tip: 'Main + Sides' }, { value: '55h', tip: 'Completionist' }],
    ...
    alts: [
      {
        title: 'HD 1.5 Remix (Theater Mode)',
        length: '3h',
      },
    ],
  },
  ...
  { chronoOrder: 200, recommendedOrder: 300, mediaType: 'Game',
    ...
    primary: { mainline: true, tags: ['Sequel', 'Action RPG', 'Hack and slash', 'Single-player'],
      length: [{ value: '29½h', tip: 'Main Story' }, { value: '39½h', tip: 'Main + Sides' }, { value: '69h', tip: 'Completionist' }],
  ...
  { chronoOrder: 230, recommendedOrder: 330, mediaType: 'Game',
    ...
    primary: { tags: ['Sequel', 'Action RPG', 'Single-player', 'Multiplayer'], helpWanted: true,
      length: [{ value: '21h', tip: 'Main Story' }, { value: '30½h', tip: 'Main + Sides' }, { value: '56½h', tip: 'Completionist' }],
  ...
  { chronoOrder: 251, recommendedOrder: 341, mediaType: 'Game',
    ...
    primary: { tags: ['Optional', 'Sequel', 'DLC', 'Action RPG', 'Single-player'],
      subtitle: 'DLC',
      length: [{ value: '4h', tip: 'Main Story' }, { value: '10½h', tip: 'Main + Sides' }, { value: '19h', tip: 'Completionist' }],
  ...
  { chronoOrder: 260, recommendedOrder: 345, mediaType: 'Game',
    ...
    primary: { tags: ['Optional', 'Rhythm', 'Single-player', 'Multiplayer', 'Co-op'],
      length: [{ value: '9h', tip: 'Main Story' }, { value: '16½h', tip: 'Main + Sides' }, { value: '52½h', tip: 'Completionist' }],
  ...
  { chronoOrder: -45, recommendedOrder: 349.5, mediaType: 'Game',
    ...
    primary: { tags: ['Optional', 'Prequel', 'RPG', 'Single-player', 'Multiplayer', 'Terminated'], helpWanted: true,
      length: [{ value: '8½h', tip: 'Main Story' }, { value: '14½h', tip: 'Main + Sides' }, { value: '18½h', tip: 'Completionist' }],
  ...
  { chronoOrder: -44, recommendedOrder: 999.7, mediaType: 'Game',
    ...
    mediaDesc: [
      [
        ...
        { emText: 'Final Fantasy Record Keeper × Kingdom Hearts Union χ [Cross] Collaboration Event' },
        { text: ', which allowed unlocking rewards in both games. The game is terminated.' },
      ],
    ],
  ...
  { chronoOrder: -40, recommendedOrder: 343, mediaType: 'Game',
    ...
    primary: { tags: ['Optional', 'Prequel', 'RPG', 'Single-player', 'Terminated'], helpWanted: true,
      length: [{ value: '47½h', tip: 'Main Story' }, { value: '49½h', tip: 'Main + Sides' }],
